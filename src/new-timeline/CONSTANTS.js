...
export const data_for_testing = [
  {
    ...
    title: "Super task",
    group: "Tests",
    details: "We need to be cool lsdasdasd as dasdasd as das das dasdasd asd a",
